...
// Dados de exemplo - você deve substituir com dados reais da sua API
const tanques = [
  { id: 1, nome: 'Tanque 1' },
  { id: 2, nome: 'Tanque 2' },
  { id: 3, nome: 'Tanque 3' },
    ...
    <div className="p-8 min-h-screen bg-[#D9D9D9]">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-4xl font-extrabold text-[#042326]">Gráficos</h1>
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              <label htmlFor="tanque" className="text-sm font-medium text-[#042326]">
                Selecione o Tanque:
              </label>
              <select
                id="tanque"
                ...
                className="block w-48 rounded-lg border-[#1D7373] py-2 pl-3 pr-10 text-base focus:border-[#1D7373] focus:outline-none focus:ring-[#1D7373] sm:text-sm bg-white shadow-sm"
              >
                {tanques.map((tanque) => (
            ...
            <span className="text-sm text-[#042326]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-7 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
            <h2 className="text-xl font-bold text-[#042326] mb-4">Evolução da Biomassa</h2>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
                  <XAxis dataKey="mes" stroke="#042326" />
                  <YAxis stroke="#042326" />
                  <Tooltip 
                    contentStyle={{ 
          ...
          {/* Qualidade da Água */}
          <div className="bg-white p-7 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
            <h2 className="text-xl font-bold text-[#042326] mb-4">Qualidade da Água</h2>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
          ...
          {/* Taxa de Mortalidade */}
          <div className="bg-white p-7 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
            <h2 className="text-xl font-bold text-[#042326] mb-4">Taxa de Mortalidade</h2>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
          ...
          <div className="bg-white p-7 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300">
            <h2 className="text-xl font-bold text-[#042326] mb-4">Fator de Conversão Alimentar</h2>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
          ...
          <div className="bg-white p-7 rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-300 md:col-span-2">
            <h2 className="text-xl font-bold text-[#042326] mb-4">Projeção de Biomassa</h2>
            <div className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={data}>
                  <CartesianGrid strokeDasharray="3 3" stroke="#e5e7eb" />
